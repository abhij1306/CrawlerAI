...
_CONFIDENCE = CASCADE_NETWORK_LISTING_CONFIDENCE
_MIN_ROWS = CASCADE_NETWORK_LISTING_MIN_ROWS
_URL_TEMPLATE_RE = re.compile(CASCADE_NETWORK_URL_TEMPLATE_PATTERN)
_ZERO_UUID = CASCADE_NETWORK_ZERO_UUID
