...
from app.core.config.product_intelligence import BRAND_ALIAS_MAP, PRIVATE_LABEL_BRANDS


_DATA_DIR = Path(__file__).resolve().parents[1] / "data" / "product_intelligence"
