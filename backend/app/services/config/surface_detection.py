...
SURFACE_RESOLVER_ECOMMERCE_DETAIL_NUMERIC_HTML_MIN_LENGTH = 6
SURFACE_RESOLVER_ECOMMERCE_DETAIL_SHOP_SLUG_MIN_HYPHENS = 2
SURFACE_RESOLVER_ECOMMERCE_DETAIL_QUERY_KEYS = frozenset(
    {
        "colorcode",
        "colorproductcode",
        "pid",
...
SURFACE_RESOLVER_ECOMMERCE_DETAIL_QUERY_VALUE_PATTERN = (
    r"(?=.{4,}$)(?=.*\d)[a-z0-9][a-z0-9_-]*"
)
