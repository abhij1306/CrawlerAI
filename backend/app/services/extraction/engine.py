...
from app.services.extraction.entities import EntitySet, build_entities
from app.services.extraction.jobs import (
    collect_job_detail,
    collect_job_listing,
    wrong_surface_findings_for_job_detail,
)
from app.services.extraction.job_resolution import (
    materialize_job_detail,
    materialize_job_listing,
    resolve_job_detail,
    resolve_job_listing,
)
from app.services.extraction.listing import (
...
from app.services.extraction.resolution import resolve as resolve_ecommerce_detail
from app.services.extraction.result_building import (
...
from app.services.extraction.surfaces import Surface, SurfaceSpec, surface_spec
from app.services.extraction.targeting import (
...
from app.services.extraction.validation import validate as validate_ecommerce_detail
...
def _validate_detail(
    ...
    del request, spec
    return validate_ecommerce_detail(evidence, graph)
