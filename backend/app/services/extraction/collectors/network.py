...
from app.services.extraction.collectors.js_state import network_row
from app.services.extraction.contracts import CaptureBundle, Evidence
...
class NetworkCollector:
    ...
    def collect(self, bundle: CaptureBundle, artifacts) -> tuple[Evidence, ...]:
        ...
        for ref in bundle.artifacts:
            ...
            from app.services.extraction.collectors._helpers import json_objects
