...
ECOMMERCE_STRUCTURED_SOURCE_FACT_TYPES = {
    ...
    **dict.fromkeys(ECOMMERCE_DISPLAY_PRICE_SOURCE_KEYS, OFFER_PRICE_FACT_TYPE),
    ...
    "compare_at_price": OFFER_ORIGINAL_PRICE_FACT_TYPE,
    "compareAtPrice": OFFER_ORIGINAL_PRICE_FACT_TYPE,
    "description": PRODUCT_DESCRIPTION_FACT_TYPE,
    "image": ASSET_IMAGE_URL_FACT_TYPE,
    ...
    "name": PRODUCT_TITLE_FACT_TYPE,
    "price": OFFER_PRICE_FACT_TYPE,
    "list_price": OFFER_ORIGINAL_PRICE_FACT_TYPE,
    "listPrice": OFFER_ORIGINAL_PRICE_FACT_TYPE,
    "original_price": OFFER_ORIGINAL_PRICE_FACT_TYPE,
    "originalPrice": OFFER_ORIGINAL_PRICE_FACT_TYPE,
...
ECOMMERCE_STRUCTURED_SOURCE_VALUE_PATH_FACT_TYPES = {
    ...
    ("compare_at_price", "amount"): OFFER_ORIGINAL_PRICE_FACT_TYPE,
    ("compareAtPrice", "amount"): OFFER_ORIGINAL_PRICE_FACT_TYPE,
    ("list_price", "amount"): OFFER_ORIGINAL_PRICE_FACT_TYPE,
    ("listPrice", "amount"): OFFER_ORIGINAL_PRICE_FACT_TYPE,
    ("original_price", "amount"): OFFER_ORIGINAL_PRICE_FACT_TYPE,
    ("originalPrice", "amount"): OFFER_ORIGINAL_PRICE_FACT_TYPE,
