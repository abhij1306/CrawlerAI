...
# ``app.core.records.field_policy.repair_target_fields_for_surface`` and must not
...
ACQUIRE_EVENT_TERMINAL_FAILURE = "terminal_failure"
...
__all__ = [
    ...
    "ACQUIRE_EVENT_TERMINAL_FAILURE",
