...
DETAIL_IMAGE_SHORT_STYLE_CODE_MIN_LENGTH = 5
...
PRODUCT_ASSET_REJECT_URL_PATTERNS = (
    ...
    r"(?:^|[/_.-])checkout(?:[/_.-]|$).*\.svg(?:$|[?#])",
    r"(?:^|/)order\.svg(?:$|[?#])",
    r"(?:^|[/_.-])(?:visa|mastercard|amex|affirm|paypal|apple[_-]?pay|afterpay|klarna)(?:[_-]?(?:card|logo|lockup))?\.svg(?:$|[?#])",
    r"(?:^|[/_.-])surfacing[_-]?reviews?(?:[/_.-]|$)",
    r"(?:^|/)sub[_-]?banners?(?:/|$)",
    r"(?:^|/)(?:global(?:%20|\s|[-_])?nav|loyalty)(?:/|$)",
    r"undefined(?:$|[?#])",
    r"(?:^|/)ugc(?:/|_|$)",
    r"(?:^|[/_.-])stylehint(?:[/_.-]|$)",
