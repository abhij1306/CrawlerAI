...
MAX_DIAGNOSE_ARTIFACT_BYTES = 1_048_576
...
ECOMMERCE_MEDIA_DESCRIPTION_PATH_TOKENS = frozenset(
    {"image", "images", "asset", "assets", "media"}
)
...
LISTING_STRUCTURAL_CATEGORY_PATH_SEGMENTS = frozenset(
    {"c", "category", "categories", "collections"}
)
LISTING_MARKET_LOCALE_PRODUCT_PREFIX = "shop"
LISTING_MARKET_LOCALE_GENDER_SEGMENTS = frozenset(
