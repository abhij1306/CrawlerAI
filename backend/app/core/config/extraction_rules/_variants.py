...
VARIANT_SHADE_URL_QUERY_KEYS = ("shade", "color", "colour")
VARIANT_JSONLD_NAME_OPTION_SEPARATOR = " - "
VARIANT_JS_STATE_NON_VARIANT_TYPENAME_TOKENS = ("image", "media")
