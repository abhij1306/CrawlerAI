...
- Initial GitHub CI failed before dependency installation because the advertised `astral-sh/setup-uv@v9` tag was not resolvable. The workflow now pins the official v8.1.0 commit SHA; the same PR is being reverified.
